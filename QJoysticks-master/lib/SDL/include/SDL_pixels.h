...
#define SDL_BYTESPERPIXEL(X)                                                                                                                                   \
	(SDL_ISPIXELFORMAT_FOURCC(X) ? ((((X) == SDL_PIXELFORMAT_YUY2) || ((X) == SDL_PIXELFORMAT_UYVY) || ((X) == SDL_PIXELFORMAT_YVYU)) ? 2 : 1)                 \
								 : (((X) >> 0) & 0xFF))
...
#define SDL_ISPIXELFORMAT_ARRAY(format)                                                                                                                             \
	(!SDL_ISPIXELFORMAT_FOURCC(format)                                                                                                                              \
	 && ((SDL_PIXELTYPE(format) == SDL_PIXELTYPE_ARRAYU8) || (SDL_PIXELTYPE(format) == SDL_PIXELTYPE_ARRAYU16) || (SDL_PIXELTYPE(format) == SDL_PIXELTYPE_ARRAYU32) \
