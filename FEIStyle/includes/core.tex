...
Detegovali sme prekážky ktoré sa nachádzajú už 80cm od robota, a ak sa predmet nachádzal bližšie než 50cm od robota, zvýšili sme úroveň alarmu. Na kamere sa nevykresľujú dáta nachádzajúce sa za robotom.
...
\begin{figure}[!htbp]
	\begin{center}
		\includegraphics[width=0.95\textwidth]{img/skeleton.png}
	\end{center}
